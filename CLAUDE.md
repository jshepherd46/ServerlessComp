...
| # | Track | Title | Hours | Status |
|---|-------|-------|-------|--------|
| M5 | INFRA | Kubernetes (GKE) for research workloads | 10 | Stub |
| M6 | ML | Deep learning in the cloud: CNNs & imaging | 10 | Stub |
| M7 | ML | BERT, LLMs & frontier model deployment | 10 | Stub |
...
| # | Track | Title | Hours | Status |
|---|-------|-------|-------|--------|
| M9 | OMOP | OMOP CDM & ATLAS on GCP | 8 | Stub |
